...
![](https://s.poetries.top/uploads/2024/02/7cb972d068b2d405.png)
...
![](https://s.poetries.top/uploads/2024/02/ac9f3b53fa31e426.png)
...
![](https://s.poetries.top/uploads/2024/02/f29c1e3d3ec2e9cd.png)
...
![](https://s.poetries.top/uploads/2024/02/c51050b67f2e6cce.png)
...
![](https://s.poetries.top/uploads/2024/02/40dce2fec8ddba9a.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/qqxxlxzwm6 (opens new window)](https://codesandbox.io/s/qqxxlxzwm6)
...
![](https://s.poetries.top/uploads/2024/02/d5905502c17b331e.png)
...
![](https://s.poetries.top/uploads/2024/02/ac43bf3cdd9f397b.png)
...
![](https://s.poetries.top/uploads/2024/02/5ef13e02c0e5ea87.png)
...
![](https://s.poetries.top/uploads/2024/02/9e57680a134bdaa0.png)
...
![](https://s.poetries.top/uploads/2024/02/3b052cd3c8a45ffb.png)
...
![](https://s.poetries.top/uploads/2024/02/0da6d975e4a8630b.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/4x6qo5w34w (opens new window)](https://codesandbox.io/s/4x6qo5w34w)

### 添加新元素

在上面的讲解中，我们一直忽略了一个问题，即新 `children` 中可能包含那些不能够通过移动来完成更新的节点，例如新 `children` 中包含了一个全新的节点，这意味着在旧 `children` 中是找不到该节点的，如下图所示：

![](https://s.poetries.top/uploads/2024/02/1e2aeebfe89f58f2.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/54215km3vn (opens new window)](https://codesandbox.io/s/54215km3vn)
...
![](https://s.poetries.top/uploads/2024/02/0946ef93055c6933.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/844lp3mq72 (opens new window)](https://codesandbox.io/s/844lp3mq72)
...
![](https://s.poetries.top/uploads/2024/02/242541513654fb21.png)

在这个例子中，我们可以通过肉眼观察从而得知最优的解决方案应该是：**把 `li-c` 节点对应的真实 DOM 移动到最前面即可**，只需要一次移动即可完成更新。然而，`React` 所采用的 `Diff` 算法在更新如上案例的时候，会进行两次移动：

![](https://s.poetries.top/uploads/2024/02/9d3f42cbb025eedf.png)
...
![](https://s.poetries.top/uploads/2024/02/5d6d3836641bc1a6.png)
...
![](https://s.poetries.top/uploads/2024/02/a76e19b385e0bb88.png)
...
![](https://s.poetries.top/uploads/2024/02/777fbf4df88821ac.png)

由于 `li-d` 节点所对应的真实 DOM 元素已经更新完成且被移动，所以现在真实 DOM 的顺序是：`li-d`、`li-a`、`li-b`、`li-c`，如下图所示：

![](https://s.poetries.top/uploads/2024/02/0d30dad1934f9ce7.png)
...
![](https://s.poetries.top/uploads/2024/02/533db5e57c1ed0c9.png)
...
![](https://s.poetries.top/uploads/2024/02/5350d50f9328eedc.png)
...
![](https://s.poetries.top/uploads/2024/02/9285a505a83eb719.png)

另外，观察上图可以发现，此时 `oldStartIdx` 和 `newStartIdx` 分别比 `oldEndIdx` 和 `newEndIdx` 要大，所以这将是最后一轮的比对，循环将终止，以上就是双端比较的核心原理。

TIP

完整代码&在线体验地址：[https://codesandbox.io/s/xvmqn58jqw (opens new window)](https://codesandbox.io/s/xvmqn58jqw)
...
![](https://s.poetries.top/uploads/2024/02/0ba7c12f50e26c0d.png)
...
![](https://s.poetries.top/uploads/2024/02/dbf60539b42d2d68.png)
...
![](https://s.poetries.top/uploads/2024/02/4756ae61c44e317b.png)
...
![](https://s.poetries.top/uploads/2024/02/eec6b6621fdbe3fe.png)
...
![](https://s.poetries.top/uploads/2024/02/72b22a35eb649f11.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/vjp265qxnl (opens new window)](https://codesandbox.io/s/vjp265qxnl)

### 添加新元素

在上一小节中，我们尝试拿着新 `children` 中的第一个节点去旧 `children` 中寻找与之拥有相同 `key` 值的可复用节点，然后并非总是能够找得到，当新的 `children` 中拥有全新的节点时，就会出现找不到的情况，如下图所示：

![](https://s.poetries.top/uploads/2024/02/cf4b71dc23f86079.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/n7y46ojv4m (opens new window)](https://codesandbox.io/s/n7y46ojv4m)

但这么做真的就完美了吗？不是的，来看下面这个例子，我们更换新 `children` 中节点的顺序，如下图所示：

![](https://s.poetries.top/uploads/2024/02/bb19b23fd5e2f01e.png)
...
![](https://s.poetries.top/uploads/2024/02/27d49216f446a731.png)

接着，开始下一轮的比较，重新从第一步开始。结果和上一轮相似，同样在第二步中找到可复用的节点，所以在在这一轮的更新完成之后，其状态如下图所示：

![](https://s.poetries.top/uploads/2024/02/575d12760b7a214f.png)
...
![](https://s.poetries.top/uploads/2024/02/df0e288269753200.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/ryryx6n42m (opens new window)](https://codesandbox.io/s/ryryx6n42m)

### 移除不存在的元素

对于双端比较，最后一个需要考虑的情况是：当有元素被移除时的情况，如下图所示：

![](https://s.poetries.top/uploads/2024/02/2ed47ccfa8f1d761.png)
...
![](https://s.poetries.top/uploads/2024/02/84170a714397cccf.png)
...
![](https://s.poetries.top/uploads/2024/02/951e167b611e2bbd.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/9jnvjj1mko (opens new window)](https://codesandbox.io/s/9jnvjj1mko)

以上就是相对完整的双端比较算法的实现，这是 `Vue2` 所采用的算法，借鉴于开源项目：[snabbdom (opens new window)](https://github.com/snabbdom/snabbdom)，但最早采用双端比较算法的库是 [citojs (opens new window)](https://github.com/joelrich/citojs)。

## inferno 所采用的核心 Diff 算法及原理

在 `Vue3` 中将采用另外一种核心 `Diff` 算法，它借鉴于 [ivi (opens new window)](https://github.com/localvoid/ivi) 和 [inferno (opens new window)](https://github.com/infernojs/inferno)，看下图：

![](https://s.poetries.top/uploads/2024/02/43852502ee805c67.png)
...
![](https://s.poetries.top/uploads/2024/02/98ff5648c1f88aa0.png)
...
![](https://s.poetries.top/uploads/2024/02/c305b75701e656bd.png)
...
![](https://s.poetries.top/uploads/2024/02/34db6465517e137d.png)
...
![](https://s.poetries.top/uploads/2024/02/551f06d3ef7d406c.png)
...
![](https://s.poetries.top/uploads/2024/02/259e38c163a108f3.png)
...
![](https://s.poetries.top/uploads/2024/02/bf0d01d8591785d5.png)
...
![](https://s.poetries.top/uploads/2024/02/72ad5e212e91dd09.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/5yo3z824vp (opens new window)](https://codesandbox.io/s/5yo3z824vp)
...
![](https://s.poetries.top/uploads/2024/02/e84d15488ca03103.png)
...
![](https://s.poetries.top/uploads/2024/02/bd15caf79547be3b.png)
...
![](https://s.poetries.top/uploads/2024/02/1769ec0ba9b839e8.png)
...
![](https://s.poetries.top/uploads/2024/02/cca8bd2f87113572.png)
...
![](https://s.poetries.top/uploads/2024/02/8357c1d08b890091.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/03o5plkv40 (opens new window)](https://codesandbox.io/s/03o5plkv40)
...
![](https://s.poetries.top/uploads/2024/02/0247ef85f7193595.png)
...
![](https://s.poetries.top/uploads/2024/02/ad107acffec84302.png)
...
![](https://s.poetries.top/uploads/2024/02/c76f51298d38eddc.png)
...
![](https://s.poetries.top/uploads/2024/02/4c6368adfcffef30.png)
...
![](https://s.poetries.top/uploads/2024/02/c85dd5b64334f95a.png)

`li-c` 节点既不是新节点，也不需要被移动，至此循环结束，更新完成。

TIP

完整代码&在线体验地址：[https://codesandbox.io/s/4lrqpv0jm9 (opens new window)](https://codesandbox.io/s/4lrqpv0jm9)
...
![](https://s.poetries.top/uploads/2024/02/1671dc4db3f0b758.png)

我们为原序列中的每个数字分配一个格子，并且这些格子填充 `1` 作为初始值：

![](https://s.poetries.top/uploads/2024/02/b15c88e922459f70.png)

根据前面的分析，我们分别求得子问题的序列 `[ 10 ]` 和 `[ 2, 10 ]` 的最长递增子序列的长度分别为 `1` 和 `2`，所以我们修改对应的格子中的值，如下：

![](https://s.poetries.top/uploads/2024/02/b51e0457a2138c06.png)
...
![](https://s.poetries.top/uploads/2024/02/ab459ef95b43afe5.png)
...
![](https://s.poetries.top/uploads/2024/02/31c22d597b0f4086.png)
...
![](https://s.poetries.top/uploads/2024/02/fdf441cff77e4b4e.png)
...
![](https://s.poetries.top/uploads/2024/02/26b78b7de0b4667b.png)
...
完整代码&在线体验地址：[https://codesandbox.io/s/32wjmo7omq (opens new window)](https://codesandbox.io/s/32wjmo7omq)
