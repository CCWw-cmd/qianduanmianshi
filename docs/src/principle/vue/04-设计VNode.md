...
![](https://s.poetries.top/uploads/2024/02/91644f2f0ad1d19b.png)
...
实际上 `Vue3` 在 `Virtual DOM` 的优化上采用的就是 [inferno (opens new window)](https://github.com/infernojs/inferno) 的手段。具体如何做我们会在后面的章节介绍。
...
COMPONENT\_STATEFUL\_NORMAL

1 << 2

000000`1`00

COMPONENT\_STATEFUL\_SHOULD\_KEEP\_ALIVE

1 << 3

00000`1`000

COMPONENT\_STATEFUL\_KEPT\_ALIVE
