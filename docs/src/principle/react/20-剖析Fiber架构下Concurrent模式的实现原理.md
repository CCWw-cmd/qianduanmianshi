...
![](https://s.poetries.top/images/20210502093019.png)
...
![](https://s.poetries.top/images/20210502093033.png)
...
![](https://s.poetries.top/images/20210502093050.png)
...
![](https://s.poetries.top/images/20210502093120.png)
...
![](https://s.poetries.top/images/20210502093141.png)

请你关注图中两处标红的函数调用，你会看到 dispatchAction 方法在 performSyncWorkOnRoot 的左边。也就是说整体的更新链路应该是这样的：

![](https://s.poetries.top/images/20210502093156.png)

`dispatchAction` 中，会完成 update 对象的创建，如下图标红处所示：

![](https://s.poetries.top/images/20210502093208.png)
...
![](https://s.poetries.top/images/20210502093233.png)
...
![](https://s.poetries.top/images/20210502093304.png)
...
![](https://s.poetries.top/images/20210502093315.png)
...
![](https://s.poetries.top/images/20210502093328.png)
...
![](https://s.poetries.top/images/20210502093359.png)
...
![](https://s.poetries.top/images/20210502093441.png)
...
![](https://s.poetries.top/images/20210502093521.png)

当我使用 ReactDOM.render 来渲染这个长列表时，它的调用栈如下图所示：

![](https://s.poetries.top/images/20210502093533.png)
...
![](https://s.poetries.top/images/20210502093551.png)
...
![](https://s.poetries.top/images/20210502093618.png)
...
![](https://s.poetries.top/images/20210502093629.png)
...
![](https://s.poetries.top/images/20210502093654.png)

其中 unstable\_now 这里实际取的就是 performance.now() 的值，即“当前时间”。那么 deadline 又是什么呢？它可以被理解为当前时间切片的到期时间，它的计算过程在 Scheduler 包中的 performWorkUntilDeadline 方法里可以找到，也就是下图的标红部分：

![](https://s.poetries.top/images/20210502093706.png)
...
在“更新链路要素拆解”这一小节的末尾，我们已经知道，无论是 scheduleSyncCallback 还是 scheduleCallback，最终都是通过调用 unstable\_scheduleCallback 来发起调度的。unstable\_scheduleCallback 是 Scheduler 导出的一个核心方法，它将结合任务的优先级信息为其执行不同的调度逻辑。
...
![](https://s.poetries.top/images/20210502093842.png)
