...
![](https://s.poetries.top/gitee/2020/07/fe/6.png)
...
![](https://s.poetries.top/gitee/2020/07/fe/7.png)
...
![](https://s.poetries.top/gitee/2020/07/fe/8.png)

> 从图中我们可以看到，我们可以将多个指令配合起来一起使用，达到多个目的。比如说我们希望资源能被缓存下来，并且是客户端和代理服务器都能缓存，还能设置缓存失效时间等

**一些常见指令的作用**

![](https://s.poetries.top/gitee/2020/07/fe/9.png)
...
![](https://s.poetries.top/gitee/2020/07/fe/10.png)
...
![](https://s.poetries.top/uploads/2022/08/b0f21ec685ae839b.png)
...
![](https://s.poetries.top/uploads/2023/02/2ed64c281a747078.png)

**合成事件图示**

![](https://s.poetries.top/uploads/2023/02/bd7cd8acbb3cfd85.png)
...
![](https://s.poetries.top/uploads/2023/02/1ede1982d9eb5a45.png)

2. `batchUpdate`机制

![](https://s.poetries.top/uploads/2023/02/7bb96642c305b9d6.png) ![](https://s.poetries.top/uploads/2023/02/e0e5828f54c4d6a1.png)
...
![](https://s.poetries.top/uploads/2023/02/4b2c232c6b39d3ac.png) ![](https://s.poetries.top/uploads/2023/02/5a0b0ab821739984.png) ![](https://s.poetries.top/uploads/2023/02/ad98ab68ffa45716.png)
...
* 渲染过程
  * `setState(newState)` \=> `newState`存入`pending`队列，判断是否处于`batchUpdate`状态，保存组件于`dirtyComponents`中（可能有子组件） ![](https://s.poetries.top/uploads/2023/02/1ede1982d9eb5a45.png)
...
![](https://s.poetries.top/uploads/2023/02/bd495d045b61d7bc.png)
...
![](https://s.poetries.top/uploads/2023/02/ee5e71b37a63fb7b.png)
...
![](https://s.poetries.top/uploads/2022/09/195112577f1777bf.png)
...
![](https://s.poetries.top/uploads/2022/09/2b1da6bb8a3fd972.png)
...
* 优化`babel-loader`缓存 ![](https://s.poetries.top/uploads/2023/02/a9f33d5b7fb0dfad.png)
...
* `noParse` 避免重复打包（引入但不打包） ![](https://s.poetries.top/uploads/2023/02/0a9cd08a1e89e2f1.png)
* `happyPack`多线程打包
...
* 自动刷新（开发环境）使用`dev-server`即可 ![](https://s.poetries.top/uploads/2023/02/d88cc6944c88ef16.png)
* 热更新（开发环境）
...
![](https://s.poetries.top/uploads/2023/02/7d1c0a6aff18214a.png)
...
![](https://s.poetries.top/uploads/2023/02/5c6bd3977e62de20.png)
