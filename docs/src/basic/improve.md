...
![](https://s.poetries.top/images/20210414100319.png)
...
![](https://s.poetries.top/images/20210414155100.png)
...
![](https://s.poetries.top/gitee/2020/09/6.png)
...
![](https://s.poetries.top/images/20210406201055.png)
...
![](https://s.poetries.top/images/20210516162034.png) ![](https://s.poetries.top/images/20210516162330.png)

> 自动执行的情况 会输出 listener1 listener2 task1 task2

![](https://s.poetries.top/images/20210516162704.png) ![](https://s.poetries.top/images/20210516163038.png)
...
![](https://s.poetries.top/images/20210414211850.png) ![](https://s.poetries.top/images/20210516214402.png) ![](https://s.poetries.top/images/20210516221825.png)
...
![](https://s.poetries.top/gitee/2020/09/7.png) ![](https://s.poetries.top/gitee/2020/09/8.png)
...
![](https://s.poetries.top/images/20210421163450.png)
...
* `dns-prefetch`。当 `link` 标签的 `rel` 属性值为“dns-prefetch”时，`浏览器会对某个域名预先进行 DNS 解析并缓存`。这样，当浏览器在请求同域名资源的时候，能省去从域名查询 IP 的过程，从而`减少时间损耗`。下图是淘宝网设置的 DNS 预解析 ![](https://s.poetries.top/images/20210421163848.png)
...
![](https://s.poetries.top/images/20210421164758.png)
...
![](https://s.poetries.top/gitee/2020/09/111.png)
...
![](https://s.poetries.top/images/20210415090353.png)
...
![](https://s.poetries.top/images/20210415092040.png)
...
![](https://s.poetries.top/images/20210415092356.png)
...
![](https://s.poetries.top/images/20210421172522.png)
...
![](https://s.poetries.top/images/20210415090547.png)
...
![](https://s.poetries.top/gitee/2020/07/fe/19.png)
...
![](https://s.poetries.top/gitee/2020/07/fe/20.png)
...
![](https://s.poetries.top/gitee/2020/09/96.png)

> 在 Cache 中也可以发现我们所需的文件已被缓存

![](https://s.poetries.top/gitee/2020/09/97.png)
...
![](https://s.poetries.top/images/20210420215756.png)
...
![](https://s.poetries.top/images/20210504134355.png)

**1\. DNS域名解析**

![](https://s.poetries.top/images/20210504134816.png)
...
![](https://s.poetries.top/images/20210504134850.png)
...
![](https://s.poetries.top/images/20210504134913.png)

结合起来的过程，可以用一个图表示：

![](https://s.poetries.top/images/20210504134925.png)
...
![](https://s.poetries.top/images/20210504135417.png)
...
![](https://s.poetries.top/images/20210504135549.png)
...
![](https://s.poetries.top/images/20210504135701.png)
...
![](https://s.poetries.top/images/20210504135900.png)
...
![](https://s.poetries.top/images/20210504140042.png)
...
![](https://s.poetries.top/images/20210504201448.png)
...
![](https://s.poetries.top/images/20210504201623.png)
...
![](https://s.poetries.top/images/20210504202154.png)
...
![img](https://s.poetries.top/images/20210328112610.png)
...
![](https://s.poetries.top/images/20210409153251.png)

**\>=16.4版本**

![](https://s.poetries.top/images/20210409153312.png)
...
![](https://s.poetries.top/images/20210425121355.png)
...
![](https://s.poetries.top/images/20210426200953.png)
...
![](https://s.poetries.top/images/20210426201045.png)
...
![](https://s.poetries.top/images/20210426201155.png)
...
![](https://s.poetries.top/images/20210407173320.png)
...
![](https://s.poetries.top/images/20210407174007.png)
...
![](https://s.poetries.top/images/20210407173933.png)
...
![](https://s.poetries.top/images/20210407173949.png)
...
![](https://s.poetries.top/images/20210425140749.png)
...
![](https://s.poetries.top/images/20210409153900.png) ![](https://s.poetries.top/images/20210409153914.png) ![](https://s.poetries.top/images/20210409153926.png) ![](https://s.poetries.top/images/20210409153942.png) ![](https://s.poetries.top/images/20210409154004.png) ![](https://s.poetries.top/images/20210409154015.png)
...
![](https://s.poetries.top/images/20210409154118.png) ![](https://s.poetries.top/images/20210409154127.png) ![](https://s.poetries.top/images/20210409154136.png)
...
![](https://s.poetries.top/images/20210425210718.png)
...
![](https://s.poetries.top/images/20210307225249.png)
...
![image-20210307224725566](https://s.poetries.top/images/image-20210307224725566.png)

那么问题来了，如果DOM节点出现了跨层级操作,diff会咋办呢？

> 答：diff只简单考虑同层级的节点位置变换，如果是跨层级的话，只有创建节点和删除节点的操作。

![image-20210307224829092](https://s.poetries.top/images/image-20210307224829092.png)
...
![image-20210302195610674](https://s.poetries.top/images/image-20210302195610674.png)

这就意味着，如果 dom 节点发生了跨层级移动，react 会删除旧的节点，生成新的节点，而不会复用。

2. `component diff`：如果不是同一类型的组件，会删除旧的组件，创建新的组件

![image-20210302195654736](https://s.poetries.top/images/image-20210302195654736.png)
...
![](https://s.poetries.top/images/20210425203918.png)

> diff 算法探讨的就是虚拟 DOM 树发生变化后，生成 DOM 树更新补丁的方式。它通过对比新旧两株虚拟 DOM 树的变更差异，将更新补丁作用于真实 DOM，以最小成本完成视图更新

![](https://s.poetries.top/images/20210425204127.png)
...
![](https://s.poetries.top/images/20210425204151.png)
...
![](https://s.poetries.top/images/20210425135711.png)
...
![](https://s.poetries.top/images/20210425135751.png)
...
![](https://s.poetries.top/images/20210409153648.png)
...
![](https://s.poetries.top/images/20210407215708.png) ![](https://s.poetries.top/images/20210407215721.png)
...
![](https://s.poetries.top/images/20210407215754.png)
...
![](https://s.poetries.top/images/20210426192237.png)

> createElement 中并没有十分复杂的涉及算法或真实 DOM 的逻辑，它的每一个步骤几乎都是在格式化数据。

![](https://s.poetries.top/images/20210426192648.png)
...
![](https://s.poetries.top/images/20210426193812.png)
...
![](https://s.poetries.top/images/20210426193901.png)

这个 `ReactElement` 对象实例，本质上是以 JavaScript 对象形式存在的对 `DOM` 的描述，也就是老生常谈的“虚拟 DOM”（准确地说，是虚拟 `DOM` 中的一个节点)

### 14 为什么 React 元素有一个 $$typeof 属性

![image-20210302200213923](https://s.poetries.top/images/image-20210302200213923.png)
...
![](https://s.poetries.top/images/20210425201821.png)
...
![](https://s.poetries.top/gitee/2020/07/68.png)
...
