...
![](https://s.poetries.top/uploads/2022/08/c2f6869e2adcf668.png)
...
![](https://s.poetries.top/uploads/2022/08/7c69c59722899f6a.png)
...
![](https://s.poetries.top/uploads/2022/08/196afd48958a52c3.png)
...
![](https://s.poetries.top/uploads/2022/08/d1162df23e6b6fa4.png)
...
![](https://s.poetries.top/gitee/2020/07/61.png)
...
![](https://s.poetries.top/uploads/2022/08/11e0dfbc20b273d4.png)
...
![](https://s.poetries.top/uploads/2022/08/c0e24e4114c32a12.png)
...
![](https://s.poetries.top/uploads/2022/08/dbe8ffb2bbf12d38.png)
...
![](https://s.poetries.top/uploads/2022/08/336264b6b10bd324.png)
...
![](https://s.poetries.top/gitee/2020/01/25.png)
...
![](https://s.poetries.top/gitee/2020/01/26.png)
...
![](https://s.poetries.top/uploads/2022/08/a263c317b0cb2793.png)
...
![](https://s.poetries.top/uploads/2022/08/99d5a09b368aeaa7.png) ![](https://s.poetries.top/uploads/2022/08/c098258e10bbeccf.png)
...
![](https://s.poetries.top/uploads/2022/08/41a0ee2dc000ecc3.png)
...
![](https://s.poetries.top/uploads/2022/08/0277951e96a40117.png)
...
![](https://s.poetries.top/uploads/2022/08/f959357382b9935a.png)
...
![](https://s.poetries.top/uploads/2022/08/c5ec33f5f3b8b6a1.png)

* 监控整个`reactive`对象，从上面的图可以看到 `deep` 实际默认是开启的，就算我们设置为`false`也还是无效。而且旧值获取不到。
* 要获取旧值则需要监控对象的属性，也就是监听一个`getter`，看下图

![](https://s.poetries.top/uploads/2022/08/f3bbb272dee1d73c.png) ![](https://s.poetries.top/uploads/2022/08/6a6bba3d39dbdc6f.png)
...
![](https://s.poetries.top/uploads/2022/08/8154cc1efc0aea96.png)
...
![](https://s.poetries.top/uploads/2022/08/8599e34fabc9a45f.gif)
...
![](https://s.poetries.top/uploads/2022/08/15b3a98fc9f361d8.png)
...
![](https://s.poetries.top/uploads/2022/09/f29c33c806ecffb5.png)

2. 比较的过程中，循环从两边向中间收拢

![](https://s.poetries.top/uploads/2022/09/8121a9b6102e5377.png)

下面举个`vue`通过`diff`算法更新的例子：

新旧`VNode`节点如下图所示：

![](https://s.poetries.top/uploads/2022/09/78fa0e7847772ef5.png)

第一次循环后，发现旧节点D与新节点D相同，直接复用旧节点D作为`diff`后的第一个真实节点，同时旧节点`endIndex`移动到C，新节点的 `startIndex` 移动到了 C

![](https://s.poetries.top/uploads/2022/09/4ddfc7e80cffdb80.png)

第二次循环后，同样是旧节点的末尾和新节点的开头(都是 C)相同，同理，`diff` 后创建了 C 的真实节点插入到第一次创建的 D 节点后面。同时旧节点的 `endIndex` 移动到了 B，新节点的 `startIndex` 移动到了 E

![](https://s.poetries.top/uploads/2022/09/7fff25b5fa48acf4.png)

第三次循环中，发现E没有找到，这时候只能直接创建新的真实节点 E，插入到第二次创建的 C 节点之后。同时新节点的 `startIndex` 移动到了 A。旧节点的 `startIndex` 和 `endIndex` 都保持不动

![](https://s.poetries.top/uploads/2022/09/4a6aa4297e796b54.png)

第四次循环中，发现了新旧节点的开头(都是 A)相同，于是 `diff` 后创建了 A 的真实节点，插入到前一次创建的 E 节点后面。同时旧节点的 `startIndex` 移动到了 B，新节点的`startIndex` 移动到了 B

![](https://s.poetries.top/uploads/2022/09/121fc9375e2537f6.png)

第五次循环中，情形同第四次循环一样，因此 `diff` 后创建了 B 真实节点 插入到前一次创建的 A 节点后面。同时旧节点的 `startIndex`移动到了 C，新节点的 startIndex 移动到了 F

![](https://s.poetries.top/uploads/2022/09/1c0782546f0e6e97.png)

新节点的 `startIndex` 已经大于 `endIndex` 了，需要创建 `newStartIdx` 和 `newEndIdx` 之间的所有节点，也就是节点F，直接创建 F 节点对应的真实节点放到 B 节点后面

![](https://s.poetries.top/uploads/2022/09/94437bcc7fdc74ba.png)
...
![](https://s.poetries.top/uploads/2023/01/4c213c57e4a91c38.png)

**React diff仅右移动**

![](https://s.poetries.top/uploads/2023/01/8c436b7f707c2e0d.png)
...
![](https://s.poetries.top/uploads/2023/01/b200d667af842b4d.png)
...
![](https://s.poetries.top/gitee/2020/07/67.png)
...
![](https://s.poetries.top/uploads/2022/08/8c7511b8697e15ea.png)
...
![](https://s.poetries.top/uploads/2022/08/9902d8c15277fb57.png)
...
![](https://s.poetries.top/uploads/2022/08/e6c7ede9c5ab6d49.png)
...
![](https://s.poetries.top/uploads/2022/09/b96d3c0fcf648316.png)
...
![](https://s.poetries.top/uploads/2022/08/0b0716bd40a4ce7c.png)
...
![](https://s.poetries.top/uploads/2022/08/e0f6b652df9a5418.png)
...
![](https://s.poetries.top/uploads/2022/08/195830df8ba5d910.png)
...
![](https://s.poetries.top/uploads/2022/08/976bacb8910af5bd.png)

**Vue 数据双向绑定原理图**

![](https://s.poetries.top/uploads/2022/08/aab95455d08d851d.png)
...
![](https://s.poetries.top/uploads/2022/09/60c6dfd81740142d.png)
...
![](https://s.poetries.top/uploads/2022/09/c3c70111cc822594.png)
...
![](https://s.poetries.top/uploads/2022/09/ee371a7be5114436.png)
...
![](https://s.poetries.top/uploads/2022/08/a50931f6f3c0cf0c.png)
...
![](https://s.poetries.top/uploads/2022/08/e2fdf798ea0f3d40.png)
...
![](https://s.poetries.top/uploads/2022/08/beabc92317439472.png)
...
[源码位置 (opens new window)](https://github1s.com/vuejs/router/blob/HEAD/packages/router/src/router.ts#L808-L809)
...
![](https://s.poetries.top/uploads/2022/08/1715e3218aeb3d7c.png)
...
![](https://s.poetries.top/gitee/2020/07/62.png)
...
![](https://s.poetries.top/gitee/2020/07/63.png)

> `modules`：项目特别复杂的时候，可以让每一个模块拥有自己的`state`、`mutation`、`action`、`getters`，使得结构非常清晰，方便管理

![](https://s.poetries.top/gitee/2020/07/64.png)
...
可以看一下[vuex-persist (opens new window)](https://github.com/championswimmer/vuex-persist/blob/master/src/index.ts#L277)内部确实是利用`subscribe`实现的
...
![](https://s.poetries.top/uploads/2022/08/0e8989f9c8100b9a.png)
...
![](https://s.poetries.top/uploads/2022/09/f223c5d4157351f4.png)
...
![](https://s.poetries.top/uploads/2022/09/c17ce45b7fdc302a.png)
...
![](https://s.poetries.top/uploads/2022/09/049a80c13ad8fba9.png)
...
![](https://s.poetries.top/uploads/2022/09/5e2b7ed267793461.png)
...
![](https://s.poetries.top/uploads/2022/09/012cda86feaa9b93.png)
...
![](https://s.poetries.top/uploads/2022/09/dbd78b33807a1196.png)

**更好的Typescript支持**

`VUE3`是基于`typescipt`编写的，可以享受到自动的类型定义提示

![](https://s.poetries.top/uploads/2022/09/440059fdfdb0fb0a.png)

**1.4 编译器重写**

![](https://s.poetries.top/uploads/2022/09/2ec6c2e81e6d9996.png)

**1.5 更接近原生**

可以自定义渲染 API

![](https://s.poetries.top/uploads/2022/09/88eb4d1859e9a619.png)

**1.6 更易使用**

响应式 `Api` 暴露出来

![](https://s.poetries.top/uploads/2022/09/5448e66d67acb711.png)

轻松识别组件重新渲染原因

![](https://s.poetries.top/uploads/2022/09/55ba7c3f18ce4330.png)
...
![](https://s.poetries.top/uploads/2022/09/b079618d8640aed7.png)
...
![](https://s.poetries.top/uploads/2022/09/f595ce429612b282.png)

关于`compositon api`的使用，这里以下图展开

![](https://s.poetries.top/uploads/2022/09/a92a5ac0c6ec602a.png)
...
官网列举的最值得注意的新特性：[v3-migration.vuejs.org (opens new window)](https://v3-migration.vuejs.org/#notable-new-features)

![](https://s.poetries.top/uploads/2022/08/d0d7ed1343411fab.png)
...
![](https://s.poetries.top/uploads/2023/02/36af2f141c7659aa.png)
...
![](https://s.poetries.top/uploads/2022/08/d299e4ac4d29052a.png)

**Vue3.0的diff算法**

`vue3.0`的`diff`算法有个叫静态标记（`PatchFlag`）的小玩意，啥是静态标记呢？简单点说，就是如果你的内容会变，我会给你一个`flag`，下次数据更新的时候我直接来对比你，我就不对比那些没有标记的了

![](https://s.poetries.top/uploads/2022/08/216dc586400c35fb.png)
...
![](https://s.poetries.top/uploads/2022/08/42c5530ad23d0361.png)
...
![](https://s.poetries.top/uploads/2022/08/87829ae3ab62f60f.gif) ![](https://s.poetries.top/uploads/2022/08/b103d51e49714aa9.gif)

**体验**

`Composition API`能更好的组织代码，下面用`composition api`可以提取为`useCount()`，用于组合、复用

![](https://s.poetries.top/uploads/2022/08/1687b11c5dfe0743.png)
...
![](https://s.poetries.top/uploads/2023/02/99525a723bd206bd.png)
...
![](https://s.poetries.top/uploads/2022/09/3886fc8c2dbc3985.png)
...
![](https://s.poetries.top/uploads/2022/09/6045e7bd46dc48f3.png)
...
![](https://s.poetries.top/uploads/2022/09/30de7985e2521249.png)
...
![](https://s.poetries.top/uploads/2022/09/0bf1724126701e32.png)
...
![](https://s.poetries.top/uploads/2022/08/a3c8cf7c4b9b8825.png)

SPA

![](https://s.poetries.top/uploads/2022/08/46149f14f3674b16.png)

**部署上的区别**

![](https://s.poetries.top/uploads/2022/08/e302c2f6998f2c7e.png)
...
!![](https://s.poetries.top/uploads/2022/09/ef93fd7632d18368.png)
...
![](https://s.poetries.top/uploads/2022/09/83f77ec966a30dd5.png)
...
![](https://s.poetries.top/uploads/2022/09/6140579886e4eada.png)
...
![](https://s.poetries.top/uploads/2022/09/ac5076060ba416f5.png)
...
[https://tangbc.github.io/vue-virtual-scroll-list (opens new window)](https://tangbc.github.io/vue-virtual-scroll-list)
...
以上为 `vue-lazyload` 插件的简单使用，如果要看插件的更多参数选项，可以查看 [vue-lazyload 的 github 地址 (opens new window)](https://github.com/hilongjw/vue-lazyload)
...
如果你的应用存在非常长或者无限滚动的列表，那么需要采用`虚拟列表`的技术来优化性能，只需要渲染少部分区域的内容，减少重新渲染组件和创建 `dom` 节点的时间。 你可以参考以下开源项目 [vue-virtual-scroll-list (opens new window)](https://github.com/tangbc/vue-virtual-scroll-list) 和 [vue-virtual-scroller (opens new window)](https://github.com/Akryum/vue-virtual-scroller) 来优化这种无限列表的场景的
...
![](https://s.poetries.top/uploads/2022/08/7b07d8079454b3db.png)
...
![](https://s.poetries.top/uploads/2022/08/ff03763e07c21600.png)
...
![](https://s.poetries.top/uploads/2022/08/5147e6ec0da2e575.png)
...
![](https://s.poetries.top/uploads/2022/08/e7a4e7fe64ff0a41.png)
...
* **用JS模拟DOM结构**  
    ![](https://s.poetries.top/uploads/2023/02/34c8532904ffd12f.png)
* **通过snabbdom学习vdom**
  * 简洁强大的`vdom`库
...
![](https://s.poetries.top/uploads/2023/02/9e81506ea3345aea.png) ![](https://s.poetries.top/uploads/2023/02/f304938694b28862.png)

**diff过程细节**

* 新旧节点都有`children`，执行`updateChildren` `diff`对比 ![](https://s.poetries.top/uploads/2023/02/2a4ac0a956e99b22.png)
  * 开始和开始对比--头头
  * 结束和结束对比--尾尾
  * 开始和结束对比--头尾
  * 结束和开始对比--尾头
...
![](https://s.poetries.top/uploads/2023/02/6f9943fe553bfa0a.png)
...
![](https://s.poetries.top/uploads/2023/02/84a8702352c0d1a7.png)
...
* **3\. 完成流程图** ![](https://s.poetries.top/uploads/2023/02/94729fa5b9fcb082.png)
...
![](https://s.poetries.top/uploads/2023/02/6c8606aaa99af5cb.png)
