...
![](https://s.poetries.top/gitee/2020/01/24.png)
...
![](https://s.poetries.top/uploads/2022/09/b3fc0062bac6f0ff.png)
...
![](https://s.poetries.top/gitee/2020/09/4.png)
...
![](https://s.poetries.top/uploads/2022/09/c4d2f6aaf3b13a69.png)
...
![](https://s.poetries.top/uploads/2022/09/c9feff5d47e9fba6.png)
...
![](https://s.poetries.top/uploads/2022/09/38d1db89f0b327e0.png)
...
![](https://s.poetries.top/uploads/2022/09/7fbfde9fbf465a8f.png)
...
![](https://s.poetries.top/uploads/2022/09/ccecc1e86f1ea0e1.png)
...
* `flex-direction: row | row-reverse | column | column-reverse;` 决定主轴的方向(即项目的排列方向)
  ...
  * `column-reverse`：主轴为垂直方向，起点在下沿 ![](https://s.poetries.top/uploads/2022/09/a6eee92bd809de3c.png)
...
* `justify-content: flex-start | flex-end | center | space-between | space-around;` 定义了项目在主轴上的对齐方式
  ...
  * `space-around`：两个项目两侧间隔相等 ![](https://s.poetries.top/uploads/2022/09/bce899ac16248797.png)
...
* `align-content: flex-start | flex-end | center | space-between | space-around | stretch;` 定义了多根轴线的对齐方式。如果项目只有一根轴线，该属性不起作用
  ...
  * `stretch`（默认值）：轴线占满整个交叉轴 ![](https://s.poetries.top/uploads/2022/09/9611b37a46dab667.png)
...
* `flex-grow: <number>;` 上面讲到当容器设为`flex-wrap: nowrap;`不换行的时候，容器宽度有不够分的情况，弹性元素会根据`flex-grow`来决定
  ...
  * 如果所有项目的`flex-grow`属性都为`1`，则它们将等分剩余空间（如果有的话） ![](https://s.poetries.top/uploads/2022/09/e9d637aaeb865268.png)
  * 如果一个项目的`flex-grow`属性为`2`，其他项目都为`1`，则前者占据的剩余空间将比其他项多一倍 ![](https://s.poetries.top/uploads/2022/09/2cf5e657b6f968c9.png)
...
* `flex-shrink: <number>; /* default 1 */` 定义了项目的缩小比例（容器宽度<元素总宽度时如何收缩），默认为`1`，即如果空间不足，该项目将缩小
  ...
  * 在容器宽度有剩余时，`flex-shrink`也是不会生效的 ![](https://s.poetries.top/uploads/2022/09/e4846a5a063570ec.png)
...
* `align-self: auto | flex-start | flex-end | center | baseline | stretch;` 允许单个项目有与其他项目不一样的对齐方式，可覆盖`align-items`属性
  * 默认值为`auto`，表示继承父元素的`align-items`属性，如果没有父元素，则等同于`stretch` ![](https://s.poetries.top/uploads/2022/09/0bbe195a6bf6a2a5.png)
...
![](https://s.poetries.top/uploads/2022/09/7a6bebde16cd0dc1.png)
...
![](https://s.poetries.top/uploads/2022/09/f3265f7748c5cab6.png)
...
* `grid-auto-flow` 属性
  ...
  * 顺序就是由`grid-auto-flow`决定，默认为行，代表"先行后列"，即先填满第一行，再开始放入第二行 ![](https://s.poetries.top/uploads/2022/09/d973d2d25b7a9641.png)
  * 当修改成`column`后，放置变为如下 ![](https://s.poetries.top/uploads/2022/09/59cb05f9412d447a.png)
...
* `justify-content` 属性， `align-content` 属性， `place-content` 属性
  ...
  * `start` - 对齐容器的起始边框
  * `end` - 对齐容器的结束边框
  * `center` - 容器内部居中 ![](https://s.poetries.top/uploads/2022/09/aa3e504f73f0a7dc.png)
  * `space-around` - 每个项目两侧的间隔相等。所以，项目之间的间隔比项目与容器边框的间隔大一倍
  * `space-between` - 项目与项目的间隔相等，项目与容器边框之间没有间隔
  * `space-evenly` - 项目与项目的间隔相等，项目与容器边框之间也是同样长度的间隔
  * `stretch` - 项目大小没有指定时，拉伸占据整个网格容器 ![](https://s.poetries.top/uploads/2022/09/36511ef68d7b786b.png)
...
* `grid-column-start` 属性、`grid-column-end` 属性、`grid-row-start` 属性以及`grid-row-end` 属性
  ...
  * 通过设置`grid-column`属性，指定`1`号项目的左边框是第二根垂直网格线，右边框是第四根垂直网格线 ![](https://s.poetries.top/uploads/2022/09/8fdf4b8f5e6babf4.png)
* `grid-area` 属性
...
![](https://s.poetries.top/uploads/2022/09/6e019fdb0f08a21f.png)
...
![](https://s.poetries.top/uploads/2022/09/7595e50c5fcf7382.png)
...
* 单行文本溢出
  ...
  * `text-overflow`只有在设置了`overflow:hidden`和`white-space:nowrap`才能够生效的
    ...
    ![](https://s.poetries.top/uploads/2022/09/25ff36e3de8eaa54.png)
...
* **常见的解决方案**
  * **zoom** 非标属性，有兼容问题，缩放会改变了元素占据的空间大小，触发重排
    ...
    * 需要注意的是，`Zoom` 并不是标准属性，需要考虑其兼容性 ![](https://s.poetries.top/uploads/2022/09/09eaff33b52d18d5.png)
